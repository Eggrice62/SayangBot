...
int main(int argc, char *argv[]) {
	...
	append_information_to_vectorstr(&outputSayang, "SayangBot이 버전 2.1로 업데이트 되었습니다. 구버전 봇을 사용하시려면 명령어 맨 앞에 . 을 붙여서 .%악보 와 같이 사용해 주세요. 만약 .%악보 쳤는데 반응이 없다면 또 죽은 것이니 몇 시간 이내로 살아날 것입니다.");
	write_file_from_string_vector("99output.sayang_"+to_string(MYPE), outputSayang);
